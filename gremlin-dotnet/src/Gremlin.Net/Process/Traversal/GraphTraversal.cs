...
namespace Gremlin.Net.Process.Traversal
{
    ...
    public class GraphTraversal<TStart, TEnd> : DefaultTraversal<TStart, TEnd>
    {
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Combine<TNewEnd> (ITraversal combineTraversal)
        {
        ...
        ///     Adds the combine step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Combine<TNewEnd> (object combineObject)
        {
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Difference<TNewEnd> (ITraversal differenceTraversal)
        {
        ...
        ///     Adds the difference step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Difference<TNewEnd> (object differenceObject)
        {
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Disjunct<TNewEnd> (ITraversal disjunctTraversal)
        {
        ...
        ///     Adds the disjunct step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Disjunct<TNewEnd> (object disjunctObject)
        {
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Intersect<TNewEnd> (ITraversal intersectTraversal)
        {
        ...
        ///     Adds the intersect step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Intersect<TNewEnd> (object intersectObject)
        {
        ...
        /// <summary>
        ///     Adds the join step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Join<TNewEnd> (string delimiter)
        {
            Bytecode.AddStep("join", delimiter);
            return Wrap<TStart, TEnd>(this);
        }
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Merge<TNewEnd> (ITraversal mergeTraversal)
        {
        ...
        ///     Adds the merge step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Merge<TNewEnd> (object mergeObject)
        {
        ...
        /// </summary>
        public GraphTraversal<TStart, TEnd> Product<TNewEnd> (ITraversal productTraversal)
        {
        ...
        ///     Adds the product step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        public GraphTraversal<TStart, TEnd> Product<TNewEnd> (object productObject)
        {
