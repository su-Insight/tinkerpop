...
*Syntax:* `combine(Object)` | `combine(Traversal)`
...
*Syntax:* `difference(Object)` | `difference(Traversal)`
...
*Syntax:* `disjunct(Object)` | `disjunct(Traversal)`
...
*Syntax:* `intersect(Object)` | `intersect(Traversal)`
...
See: link:https://github.com/apache/tinkerpop/tree/x.y.z/gremlin-core/src/main/java/org/apache/tinkerpop/gremlin/process/traversal/step/filter/JoinStep.java[source],
link:https://tinkerpop.apache.org/docs/x.y.z/reference/#join-step[reference]
...
*Syntax:* `merge(Object)` | `merge(Traversal)`
...
*Syntax:* `product(Object)` | `product(Traversal)`
