...
export class Vertex<
  ...
  TProperties extends Record<string, VertexProperties> | null | undefined = Record<string, VertexProperties>,
...
export class Edge<
  ...
  TOutVertext extends Vertex | null | undefined = Vertex,
  TInVertex extends Vertex | null | undefined = Vertex,
  TId extends number | string = number,
> extends Element<TLabel, TId> {
  constructor(
    id: TId,
    readonly outV: TOutVertext,
    readonly label: TLabel,
