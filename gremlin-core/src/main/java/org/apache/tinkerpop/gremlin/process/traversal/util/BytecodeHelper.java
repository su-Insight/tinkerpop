...
public final class BytecodeHelper {
    ...
    static {
        final Map<String, List<Class<? extends Step>>> operationStepMap = new HashMap<String, List<Class<? extends Step>>>() {{
            ...
            put(GraphTraversal.Symbols.trim, Collections.singletonList(TrimStep.class));
            put(GraphTraversal.Symbols.lTrim, Collections.singletonList(LTrimStep.class));
            put(GraphTraversal.Symbols.rTrim, Collections.singletonList(RTrimStep.class));
            ...
            put(GraphTraversal.Symbols.join, Collections.singletonList(JoinStep.class));
