...
public final class TraversalMergeStep<S, E> extends ScalarMapStep<S, E> implements TraversalParent, ListFunction {
    ...
    public TraversalMergeStep(final Traversal.Admin traversal, final Traversal<S, E> value) {
        super(traversal);
    ...
    protected E map(final Traverser.Admin<S> traverser) {
        ...
        if (mapA != null) {
            final Object mapB = (parameterItems != null) ? parameterItems : TraversalUtil.apply(traverser, valueTraversal);
            ...
            final Collection listB =
                    (null != parameterItems)
                            ? convertArgumentToCollection(parameterItems) : convertTraversalToCollection(traverser, this.valueTraversal);
