...
public final class DisjunctStep<S, E> extends ScalarMapStep<S, Set<?>> implements TraversalParent, ListFunction {
    ...
    public DisjunctStep(final Traversal.Admin traversal, final Traversal<S, E> value) {
        super(traversal);
    ...
    protected Set<?> map(Traverser.Admin<S> traverser) {
        ...
        final Set setB = (null != parameterItems) ? convertArgumentToSet(parameterItems) : convertTraversalToSet(traverser, this.valueTraversal);
