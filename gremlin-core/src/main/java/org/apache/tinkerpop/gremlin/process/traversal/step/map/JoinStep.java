 ...
 */
public final class JoinStep<S> extends ScalarMapStep<S, String> implements ListFunction {
    private String delimiter;

    public JoinStep(final Traversal.Admin traversal, final String delimiter) {
        super(traversal);
        if (null == delimiter) { throw new IllegalArgumentException("Input delimiter to join step can't be null."); }
        this.delimiter = delimiter;
    }

    @Override
    public String getStepName() { return "join"; }
    ...
    @Override
    public JoinStep<S> clone() {
        final JoinStep<S> clone = (JoinStep<S>) super.clone();
