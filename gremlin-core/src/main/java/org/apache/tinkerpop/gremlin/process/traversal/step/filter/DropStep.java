...
import static org.apache.tinkerpop.gremlin.process.traversal.step.util.event.RemovedEventUtil.registerElementRemoval;
import static org.apache.tinkerpop.gremlin.process.traversal.step.util.event.RemovedEventUtil.registerPropertyRemoval;
import static org.apache.tinkerpop.gremlin.process.traversal.step.util.event.RemovedEventUtil.hasAnyCallbacks;
    ...
    protected boolean filter(Traverser.Admin<S> traverser) {
        ...
        if (s instanceof Element) {
            ...
            if (hasAnyCallbacks(callbackRegistry)) {
                registerElementRemoval(callbackRegistry, getTraversal(), toRemove);
            }
            ...
            if (hasAnyCallbacks(callbackRegistry)) {
                registerPropertyRemoval(callbackRegistry, getTraversal(), toRemove);
            }
            toRemove.remove();
        } else
