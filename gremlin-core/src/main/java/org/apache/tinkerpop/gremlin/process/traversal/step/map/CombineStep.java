...
public final class CombineStep<S, E> extends ScalarMapStep<S, List<?>> implements TraversalParent, ListFunction {
    ...
    public CombineStep(final Traversal.Admin traversal, final Traversal<S, E> value) {
        super(traversal);
    ...
    protected List<?> map(Traverser.Admin<S> traverser) {
        ...
        final Collection listB = (null != parameterItems) ? convertArgumentToCollection(parameterItems) : convertTraversalToCollection(traverser, valueTraversal);
