...
public class ProductStepTest extends StepTest {
    ...
    @Test
    public void testReturnTypesde() {
        assertEquals(Collections.emptySet(), __.__(Collections.emptyList()).product(Collections.emptyList()).next());
        assertEquals(new HashSet(Arrays.asList(1, 2, 3)), __.__(Collections.emptyList()).product(Arrays.asList(1, 2, 3)).next());
        assertEquals(new HashSet(Arrays.asList(1, 2, 3)), __.__(Arrays.asList(1, 2, 3)).product(Collections.emptyList()).next());

        assertEquals(new HashSet(Arrays.asList(5L, 7L)), __.__(new long[] {5L, 8L, 10L}).product(new long[] {7L, 8L, 10L}).next());
        assertEquals(new HashSet(Arrays.asList(5L, 7L)), __.__(new long[] {5L, 8L, 10L}).product(__.constant(new long[] {7L, 8L, 10L})).next());

        assertEquals(new HashSet(Arrays.asList(8L, 11L)), __.__(1).constant(new Long[] {7L}).product(new Long[] {7L, 8L, 11L}).next());
        assertEquals(new HashSet(Arrays.asList(8L, 11L)), __.__(1).constant(new Long[] {7L}).product(__.constant(new Long[] {7L, 8L, 11L})).next());

        assertEquals(new HashSet(Arrays.asList(5.5, 10.1, 10.5)), __.__(new double[] {5.5, 8.0, 10.1}).product(new double[] {8.0, 10.5}).next());
        assertEquals(new HashSet(Arrays.asList(5.5, 10.1, 10.5)), __.__(new double[] {5.5, 8.0, 10.1}).product(__.constant(new double[] {8.0, 10.5})).next());
        ...
        assertEquals(new HashSet(Arrays.asList(12, 15)), __.__(setA).product(setB).next());
        assertEquals(new HashSet(Arrays.asList(12, 15)), __.__(setA).product(__.constant(setB)).next());
    }
