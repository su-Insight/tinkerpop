...
world.gremlins = {
    ...
    'g_withStrategiesXPartitionStrategyXwrite_a_read_aXX_V_bothE_weight': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a'])).V().both_e().values('weight'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_bXX_V_bothE_weight': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['b'])).V().both_e().values('weight'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_a_bXX_V_bothE_dedup_weight': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a', 'b'])).V().both_e().dedup().values('weight'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_cXX_V_bothE_weight': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['c'])).V().both_e().values('weight'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_aXX_V_both_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a'])).V().both().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_bXX_V_both_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['b'])).V().both().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_a_bXX_V_both_dedup_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a', 'b'])).V().both().dedup().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_cXX_V_both_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['c'])).V().both().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_aXX_V_out_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a'])).V().out().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_bXX_V_in_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['b'])).V().in_().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_a_bXX_V_out_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['a', 'b'])).V().out().values('name'))], 
    'g_withStrategiesXPartitionStrategyXwrite_a_read_cXX_V_out_name': [(lambda g:g.add_v('person').property('_partition', 'a').property('name', 'alice').as_('a').add_v('person').property('_partition', 'b').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('_partition', 'a').property('weight', 1).add_e('knows').from_('b').to('a').property('_partition', 'b').property('weight', 2)), (lambda g:g.with_strategies(PartitionStrategy(partition_key='_partition', write_partition='a', read_partitions=['c'])).V().out().values('name'))], 
